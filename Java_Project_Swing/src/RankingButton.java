...
public class RankingButton extends JFrame {
	...
	public RankingButton() {
		...
		lb_rk06.setFont(new Font("±º∏≤", Font.PLAIN, 20));
		...
		lb_rk01.setFont(new Font("±º∏≤", Font.PLAIN, 20));
		...
		lb_rk02.setFont(new Font("±º∏≤", Font.PLAIN, 20));
		...
		lb_rk03.setFont(new Font("±º∏≤", Font.PLAIN, 20));
		...
		lb_rk04.setFont(new Font("±º∏≤", Font.PLAIN, 20));
		...
		lb_rk05.setFont(new Font("±º∏≤", Font.PLAIN, 20));
