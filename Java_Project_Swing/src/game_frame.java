	...
	game_frame(){
		...
		if(grade.grade_case()) {
			...
			if(grade.grade_case()) {
				...
				g3=new game3(word_l,g1.input1, g2.input2,
						return_grade1, return_grade2);
				...
				if(grade.grade_case()) {
					...
					g4=new game4(word_l,g1.input1, g2.input2, g3.input3,
						return_grade1, return_grade2, return_grade3);
					...
					if(grade.grade_case()) {
						...
						g5=new game5(word_l,g1.input1, g2.input2, g3.input3, g4.input4,
								return_grade1, return_grade2, return_grade3, return_grade4);
